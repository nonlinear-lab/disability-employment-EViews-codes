...
' estimation
smpl if non_hs_diploma=0
equation eq81.ls(cov=cr,crname=st) dv iv1 iv2 did cv1 cv2 cv4 c

smpl if non_hs_diploma=1
equation eq82.ls(cov=cr,crname=st) dv iv1 iv2 did cv1 cv2 cv4 c
